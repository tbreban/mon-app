...
GBA Connect has supported companies through this specific transition. We know the pitfalls unique to V6000, the gaps to anticipate, and the decisions that must be made from the very start of scoping.

## Who this offer is for

- You are on ADP V6000 and need to plan your version exit within the schedule announced by ADP
- You are weighing up whether to stay within the ADP ecosystem (Link, Decidium) or take the opportunity to change vendor
- You want to objectively assess the data migration and configuration effort before committing to the project
- You are managing the project internally but need an expert sparring partner to challenge ADP and secure the milestones
...
- **Target decision documented and validated** by your management
- **Migration delivered** on the ADP schedule, without late-delivery penalties
- **Historical data migrated accurately**: cumulative totals, balances, social data carried over without discrepancy
- **First post-cutover payroll run** consistent with the reference payroll

## Format & duration

A long-term project, generally between **9 and 18 months** depending on the chosen target and data volume. Time & materials or fixed price per phase.

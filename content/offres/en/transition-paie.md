...
- You are facing a sudden departure or extended absence in a key payroll role
- Your recruitment is taking time and you cannot leave payroll without a competent operator
- You are going through a peak activity period (merger, acquisition, HRIS deployment) and your team is overloaded
- You want to secure the handover between two role-holders with a profile who guarantees continuity

## Two profile types depending on your needs

**The interim payroll administrator** steps in to ensure operational production: processing variable pay elements, calculating payslips, issuing DSN filings, handling complex cases (retroactive adjustments, sick leave, final pay settlements). They integrate into your existing team and maintain your payroll's usual pace.

**The interim payroll manager** goes further: in addition to production, they take charge of managing the existing team, organising workloads, prioritising topics, and coordinating with your HR, CFO, and management stakeholders. This is the right answer when the vacant position is that of a payroll lead or senior reference.
...
- **Zero interruption** in payroll production during the transition period
- **DSN filings submitted on time** with no penalties or retroactive adjustments
- **Documented handover**: the next role-holder has a clear, structured working foundation
- **HR team relieved** of the operational burden, refocused on recruitment or the returning employee

## Format & duration

Variable-length assignment depending on context: from **a few weeks** for a short-term replacement to **several months** to cover an unfilled position. Start-up possible within **48 to 72 hours** after scoping the assignment. Billed on a time-and-materials or monthly fixed-fee basis depending on the situation.

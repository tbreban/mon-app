...
- Vous voulez **professionnaliser et industrialiser** votre contrôle de paie sans dépendre d'une prestation externe récurrente
- Vous portez la responsabilité paie (DRH, DAF, Resp. Paie) et avez besoin d'un référentiel **opposable** en interne et en externe
- Vos équipes paie sont expérimentées mais vos contrôles ne sont **ni formalisés ni traçables** de manière homogène
- Vous êtes à un moment-clé : intégration d'une entité, refonte des processus, changement de Responsable Paie, contexte d'audit légal renforcé
...
- **Référentiel de contrôle documenté** et appropriable par toute nouvelle recrue paie
- **Couverture des contrôles** : 100% des rubriques à enjeu, des populations sensibles, des événements de gestion à risque
- **Traçabilité opposable** : chaque cycle paie laisse une trace de contrôle, datée et imputée
- **Autonomie effective** des équipes à la fin de la mission, mesurée sur deux cycles paie consécutifs sans intervention de GBA Connect

## Format & durée

Projet en forfait, généralement entre **6 et 10 semaines** selon le périmètre (nombre de populations, de conventions collectives, complexité paramétrale).

Après la mission, vos équipes opèrent en autonomie. GBA Connect reste disponible **à votre initiative** pour intervenir ponctuellement : revue annuelle du référentiel, accompagnement sur un événement particulier (intégration, changement de paramétrage majeur), ou appui en cas de question complexe.
